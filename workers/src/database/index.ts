    ...
    switch (node.type) {
      ...
      case 'vmess':
        ...
        Object.assign(dbNode, {
          ...
          tls: vmessNode.tls === true,
          sni: vmessNode.sni || null,
          alpn: vmessNode.alpn ? JSON.stringify(vmessNode.alpn) : null,
          fingerprint: vmessNode.fingerprint || null,
          allow_insecure: vmessNode.allowInsecure === true,
      ...
      case 'trojan':
        ...
        Object.assign(dbNode, {
          ...
          allow_insecure: trojanNode.allowInsecure === true,
          network: trojanNode.network || 'tcp',
          tls: trojanNode.tls === true,
      ...
      case 'socks5':
        ...
        Object.assign(dbNode, {
          ...
          tls: socks5Node.tls === true,
          sni: socks5Node.sni || null,
          fingerprint: socks5Node.fingerprint || null,
          allow_insecure: socks5Node.allowInsecure === true,
        });
        break;
      ...
      case 'hy2':
        ...
        Object.assign(dbNode, {
          ...
          allow_insecure: hy2Node.allowInsecure === true,
          tls: hy2Node.tls === true,
      ...
      case 'hy':
        ...
        Object.assign(dbNode, {
          ...
          allow_insecure: hyNode.allowInsecure === true,
          tls: hyNode.tls === true,
